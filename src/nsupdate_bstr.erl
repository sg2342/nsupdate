-module(nsupdate_bstr).

-export([type/1, class/1]).

-include_lib("dns_erlang/include/dns.hrl").

class(B) ->
    case B of
	?DNS_CLASS_IN_BSTR -> ?DNS_CLASS_IN;
	?DNS_CLASS_CS_BSTR -> ?DNS_CLASS_CS;
	?DNS_CLASS_CH_BSTR -> ?DNS_CLASS_CH;
	?DNS_CLASS_HS_BSTR -> ?DNS_CLASS_HS;
	?DNS_CLASS_NONE_BSTR -> ?DNS_CLASS_NONE;
	?DNS_CLASS_ANY_BSTR -> ?DNS_CLASS_ANY
    end.
